...
public class AuthConstant {
    ...
    public static final String USER_NOT_FOUND_ID_ERROR = "User with id: %s not found";
    public static final String USER_NOT_FOUND_LOGIN_ERROR = "User with login: %s not found";
